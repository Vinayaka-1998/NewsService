...
class NewsViewController: UIViewController {
    ...
    func pushToNewsDetailViewController(source: String, sourceName: String) {
        let newsDetailViewController = NewsDetailViewController()
        newsDetailViewController.fetchDertaisOfSource(source: source, sourceName: sourceName)
...
extension NewsViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let source = article.source.id {
            pushToNewsDetailViewController(source: source, sourceName: article.source.name)
        } else {
            CustomAlertController.show(on: self, title: "Details not present")
        }
    }
}
